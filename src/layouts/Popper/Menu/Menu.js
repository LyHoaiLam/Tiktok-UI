...
function Menu({ children, items = [], hideOnClick = false, onChange = defaultFc }) {
    ...
    const hanleResetToFirstPage = () => setHistory((prev) => prev.slice(0, 1))
    // const hanleResetToFirstPage = { () => setHistory((prev) => prev.slice(0, 1)) Tương tự}
